...
int coroutine_fn v9fs_co_fchmod(V9fsPDU *pdu, V9fsFidState *fidp, mode_t mode)
{
    int err;
    FsCred cred;
    V9fsState *s = pdu->s;
...
int coroutine_fn v9fs_co_futimens(V9fsPDU *pdu, V9fsFidState *fidp, struct timespec times[2])
{
    int err;
    V9fsState *s = pdu->s;
...
int coroutine_fn v9fs_co_fchown(V9fsPDU *pdu, V9fsFidState *fidp, uid_t uid, gid_t gid)
{
    int err;
    FsCred cred;
    V9fsState *s = pdu->s;
